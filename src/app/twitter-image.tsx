...
export const alt = "TalScout — Stop typing résumés. Start finding talent.";

// Share-link preview image: same teal icon badge + wordmark as the landing
// page navbar (LandingNav), on the brand cream background.
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
          ...
          >
            <svg width="75" height="75" viewBox="0 -960 960 960" fill="#ffffff">
