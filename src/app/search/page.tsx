        ...
        <TopAppBar
          ...
          rightContent={
            <Button asChild variant="gradient" className="whitespace-nowrap">
              <Link href="/upload">+ Upload résumé</Link>
            </Button>
          }
        />
              ...
              <form onSubmit={handleSearchSubmit}>
                <Card className="flex flex-col sm:flex-row items-stretch sm:items-center w-full p-2 gap-2 focus-within:border-primary transition-colors">
                  ...
                  <Button
                    ...
                    size="lg"
                    disabled={loading}
                    className="w-full justify-center bg-tertiary-fixed text-on-tertiary-fixed hover:bg-tertiary-fixed-dim active:scale-[0.97] sm:w-auto"
                  >
                      ...
                      <CardContent className="flex flex-1 flex-col">
                        ...
                        <div className="flex justify-between items-start mb-3 gap-3">
                          <div className="flex items-center gap-3 min-w-0">
                            <Link href={`/candidates/${c.id}`} className="w-11 h-11 rounded-full overflow-hidden bg-primary-container/15 flex items-center justify-center text-primary font-body-md font-semibold flex-shrink-0">{initials}</Link>
                            <div className="min-w-0">
                              <h3 className="font-body-md font-semibold text-headline-md text-on-surface flex items-center gap-1.5 truncate">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {(c.skills || []).slice(0, 4).map((skill) => (
                            <Badge key={skill} variant="outline" className="rounded-md font-data-mono text-data-mono bg-surface-container-low text-on-surface-variant border-border-low-alpha">{skill}</Badge>
                          ))}
                        </div>
                        {/* Actions */}
                      ...
                      <CardContent>
                        ...
                        <div className="flex justify-between items-start mb-4">
                          <div className="flex items-center gap-4">
                            <Link href={`/candidates/${c.id}`} className="w-14 h-14 rounded-full overflow-hidden bg-primary-container/15 flex items-center justify-center text-primary font-body-md font-semibold flex-shrink-0">{initials}</Link>
                            <div>
                              <h3 className="font-body-md font-semibold text-headline-md text-on-surface flex items-center gap-2">
                          ...
                          {(c.skills || []).map((skill) => {
                            ...
                            return (
                              <Badge
                                ...
                                className={
                                  isMatched
                                    ? "rounded-md font-data-mono text-data-mono bg-tertiary-fixed/20 text-on-tertiary-fixed border-tertiary-fixed/30"
                                    : "rounded-md font-data-mono text-data-mono bg-surface-container-low text-on-surface-variant border-border-low-alpha"
                                }
                              >
                                {skill}
                              </Badge>
