        ...
        <div className="bg-surface-white rounded-[16px] shadow-[0_4px_24px_rgba(44,35,34,0.05)] p-6 sm:p-8 md:p-10 border border-border-low-alpha/50">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <input className="w-full bg-surface-bright border border-outline-variant rounded-lg px-4 py-3 font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors placeholder:text-outline-variant/60" id="agency_name" name="agency_name" placeholder="Acme Recruitment" type="text" />
            </div>
            {/* Workspace URL */}
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full bg-surface-bright border border-outline-variant rounded-lg px-4 py-3 font-body-md text-body-md text-on-surface appearance-none focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors cursor-pointer" id="industry" name="industry" defaultValue="">
            ...
            {/* Actions */}
            <div className="pt-4">
              <Link href="/onboarding/plan" className="w-full bg-primary text-on-primary font-label-md text-label-md py-3 px-6 rounded-lg shadow-sm hover:bg-primary-container transition-colors duration-200 flex justify-center items-center gap-2">
                Continue
