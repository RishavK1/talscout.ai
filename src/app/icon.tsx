...
// Same badge treatment as the navbar logo (LandingNav): teal rounded-square
// with the "travel_explore" Material Symbols glyph in white.
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="20" height="20" viewBox="0 -960 960 960" fill="#ffffff">
