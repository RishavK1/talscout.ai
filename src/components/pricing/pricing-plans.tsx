...
const plans: Plan[] = [
  {
    ...
    annual: 79,
    features: [
      { icon: "check_circle", label: "Basic resume parsing" },
      { icon: "check_circle", label: "Simple keyword search" },
      { icon: "check_circle", label: "Up to 500 candidates" },
    ],
  },
  {
    name: "Growth",
    ...
    highlighted: true,
    features: [
      { icon: "check_circle", label: "Everything in Starter" },
      { icon: "stars", label: "Full Semantic AI Search", emphasized: true },
      { icon: "check_circle", label: "Automated talent matching" },
      { icon: "check_circle", label: "Advanced CRM integration" },
    ],
  },
  {
    name: "Scale",
    ...
    features: [
      ...
      { icon: "check_circle", label: "Unlimited parsing & storage" },
      { icon: "check_circle", label: "Priority 24/7 support" },
      { icon: "check_circle", label: "Custom API access" },
    ],
  },
];
